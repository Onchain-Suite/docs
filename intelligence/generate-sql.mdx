...
Other AI features draw from the same monthly AI-credit allowance at higher rates. A copywriting or segment-rule suggestion costs 5, and a turn with the [AI assistant](/intelligence/overview#ai-assistant), which can reason and run queries, costs 10. Your plan's allowance is listed on [Plans and billing](/settings/plans-and-billing).
