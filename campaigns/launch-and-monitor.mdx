...
| Delivery rate | Delivered ÷ (delivered + bounces) |
| Bounce rate | Bounces ÷ (delivered + bounces) |
| Open, click, unsubscribe rate | Over delivered, falling back to sent |
| Click-to-open rate | Unique clicks ÷ unique opens |

Delivery and bounce rate are shares of **delivery attempts**, the two add up to 100%, which matches how your email provider's console reports them. Rates are percentages rounded to two decimals, and zero when the denominator is zero.
