...
<Note>
**Coming soon.** These reports are in active development ([tracking](https://github.com/onchainsuite/backend/pull/298)) and are not on production yet. The endpoint paths and response shapes below are documented from the source contract so you can build against them, but they may change before release. Where a metric is not yet wired, it's called out inline.
</Note>
