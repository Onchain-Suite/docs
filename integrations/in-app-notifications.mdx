...
- You're on React or Next.js and want the shape that's running in production, use **React (production shape)**.
...
### React (production shape)

Mount one component high in the tree, keyed on the connected wallet. This is the shape running in production.
