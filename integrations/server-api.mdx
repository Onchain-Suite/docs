...
<Note>
**In plain terms.** This is the toolkit your backend uses to talk to Onchain Suite directly, no dashboard, no browser. A developer keeps one secret key on the server and calls these to register wallets, pull in consented emails, send a push, or kick off a campaign. If all you want is notifications inside your dApp, you don't need this, use the [in-app SDK](/integrations/in-app-notifications) instead.
</Note>
