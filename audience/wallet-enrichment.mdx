...
Enrichment consumes **wallet-data credits**, roughly 4 per wallet, covering balances, transactions, NFTs, and portfolio. Each paid plan includes a monthly allowance:
