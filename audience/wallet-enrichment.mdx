...
Enrichment consumes **wallet-data credits** (GoldRush) — roughly 4 per wallet, from four data calls: balances, transactions, NFTs, and portfolio. Each paid plan includes a monthly allowance:

| Plan | Monthly credits | Roughly this many wallets |
| --- | --- | --- |
| **Pay as you go** | Metered — $10 per 10,000 credits | — |
| **Launch** — $49/mo | 1,000 | ~250 |
| **Growth** — $349/mo | 10,000 | ~2,500 |
| **Pro** — $799/mo | 25,000 | ~6,000 |
| **Scale** — $2,299/mo | 50,000 | ~12,000 |

Once the allowance is exhausted, new enrichment is blocked — the SQL editor and your already-enriched data keep working. On Pay as you go, enrichment draws from your balance at $10 per 10,000 credits (about 4¢ a wallet) rather than a monthly allowance.
